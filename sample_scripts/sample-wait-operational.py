...
def parseargv(argv):
    ...
    parser = argparse.ArgumentParser(
        description="Db2 Analytics Accelerator wait for operational."
    )
    ...
    return (lparAccess, options.licPath, options.verbose, options.lparip)
...
def main(argv):
    ...
    print("*************************************************************")
    print
    print("  Db2 Analytics Accelerator wait operational")
    print
    print("*************************************************************")
    try:
        lparAccess, licPath, verbose, lparip = parseargv(argv)
        ...
        print("Wait for operational appliance")
