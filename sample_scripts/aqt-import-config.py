...
# Import appliance configuration file
#
###################################################################
...
def parseargv(argv):
    ...
    parser = argparse.ArgumentParser(
        description="Db2 Analytics Accelerator import configuration."
    )
...
def main(argv):
    ...
    print("*************************************************************")
    print()
    print("  Db2 Analytics Accelerator import configuration")
    print()
    print("*************************************************************")
    try:
        ...
        with open(configfile, "rb") as f:
            resultCode = ssc.import_configuration(f)
            log.debug(resultCode)
            if resultCode.status_code == 202:
                print("***********************************************************")
                print("Configuration file", configfile, " successfully imported")
                print("(Restart of the appliance triggered asynchronously)")
                print("***********************************************************")
            else:
                raise Exception("Import of configuration file failed")
